...
#import "ColorsViewController_iPad.h"


@implementation ColorsViewController_iPad
...
-(void)moveStar
{
	...
	[movePath moveToPoint:CGPointMake(starStartXPosition, starStartYPosition)];
	[movePath addQuadCurveToPoint:CGPointMake(starEndXPosition, starEndYPosition)
					 controlPoint:ctlPoint];
	
	rotateAnimation.path = movePath.CGPath;
