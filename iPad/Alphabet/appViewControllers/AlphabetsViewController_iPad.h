...
#define VELOCITY_BALL_X 4.0f
#define VELOCITY_BALL_Y 4.0f
#define RADIUS_BALL	8.0f
#define MIN_Y_BALL 150
#define MAX_Y_BALL 300
...
@interface AlphabetsViewController_iPad : UIViewController<AVAudioPlayerDelegate, AnimateObjectViewDelegate> {
