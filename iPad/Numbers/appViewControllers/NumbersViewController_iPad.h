...
#define ROW_SPACE 38
#define COLUMN_SPACE 38

#define GRAPHIC_MAX_WIDTH 200
#define GRAPHIC_MAX_HEIGHT 160
...
@interface NumbersViewController_iPad : UIViewController<AVAudioPlayerDelegate, ConfettiViewDelegate, MainWindowDelegate> {
